...
if (event) {
    ...
    const expectContainer = document.getElementById("event-expect");

    event.expect.forEach(item => {

        const p = document.createElement("p");

        p.textContent = item;

        expectContainer.appendChild(p);
...
function goToRegistration() {
    ...
    window.location.href = "event_registration.html?id=" + eventId;
}